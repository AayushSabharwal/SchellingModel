...
recovered_duration = 14  # how long agents stay recovered. -1 for infinitely
...
population_birth_rate = 0.  # number of births per iteration as fraction of currently alive people
population_death_rate = 0.  # number of deaths per iteration as fraction of currently alive people

...
population_birth_rate = 0.0164  # number of births per iteration as fraction of currently alive people
population_death_rate = 0.0036  # number of deaths per iteration as fraction of currently alive people
